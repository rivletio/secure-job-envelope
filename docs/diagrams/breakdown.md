...
graph TD
  ...
  E_archive --> S_import-and-export-sje-archives["Import and export traveler archives"]
  ...
  S_itar-self-declaration-guards --> S_93b9ae51("·  ITAR self-declared seller can quote an ITAR traveler")
