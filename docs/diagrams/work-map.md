...
flowchart TB
  subgraph W1["Start now · wave 1"]
    ...
    S_6428f647["S-6428f647  Executable packet ignores amend"]
    S_3d08634f["S-3d08634f  Executable packet refuses new quotes"]
    S_8cf485e5["S-8cf485e5  Upserting over an executable packet is refused"]
    ...
    S_7cd6dc95["S-7cd6dc95  Award is refused when the packet is already executable"]
    ...
    S_fb69dc1d["S-fb69dc1d  Seal creates an L0 packet and navigates to it"]
    S_addded0e["S-addded0e  Cannot seal a Draft packet"]
    S_f6d7fcdc["S-f6d7fcdc  ITAR self-declaration shows a non-compliance notice"]
    S_ef846a17["S-ef846a17  Missing quoteable field keeps the packet at Draft"]
    ...
    S_a3ab4c9d["S-a3ab4c9d  Bound quotes must match the current packet hash"]
    S_9b6c36d9["S-9b6c36d9  Non-ITAR seller quote is excluded from bound set on an ITAR packet"]
    S_4006e8e8["S-4006e8e8  Seed desk shows four packets across conformance levels"]
    S_89278d6f["S-89278d6f  Filter desk to L0 quoteable packets"]
    S_661e8d23["S-661e8d23  Filter desk to L2 executable packets"]
    S_a9928cd6["S-a9928cd6  Empty filter shows a recovery hint"]
    S_b6290ddd["S-b6290ddd  Packet card links to the packet page"]
    S_d3e99edd["S-d3e99edd  Reset seed replaces every packet and keeps audit"]
    S_7a1d7a4a["S-7a1d7a4a  Buyer sees New packet; seller sees Spec instead"]
    ...
    S_eccb855a["S-eccb855a  Extra keys on the in-memory packet do not enter the hash"]
    S_9b54f554["S-9b54f554  Buyer contact is hashed when present"]
    S_b1b7c6e3["S-b1b7c6e3  Adding quotes does not change packet_hash"]
    S_2b9028c4["S-2b9028c4  Non-finite and out-of-range numbers are refused by canonicalization"]
    S_2f13412c["S-2f13412c  Export rivpkt zip downloads the archive and audits"]
    S_81f75882["S-81f75882  Export JSON downloads packet json"]
    S_a3fc34f2["S-a3fc34f2  Round-trip zip preserves packet id and hash"]
    S_5f007835["S-5f007835  Open plain packet JSON from the desk"]
    ...
    S_27956542["S-27956542  META packet_hash mismatch is rejected"]
    S_8fc9037d["S-8fc9037d  META packet_id mismatch is rejected"]
    S_5b35da2f["S-5b35da2f  File larger than 2 MB is rejected"]
    S_c1c6d06f["S-c1c6d06f  Import will not overwrite a locked L2 packet"]
    S_592f14fc["S-592f14fc  Non-ITAR seller cannot quote an ITAR packet"]
    S_93b9ae51["S-93b9ae51  ITAR-registered seller can quote an ITAR packet"]
    S_b6d7545e["S-b6d7545e  Cannot award an ITAR packet to a non-ITAR seller quote"]
    S_fc1aafa4["S-fc1aafa4  Import of an ITAR packet asks for confirmation"]
    S_2b55a99f["S-2b55a99f  Cancel ITAR import leaves the desk unchanged"]
    S_e970044a["S-e970044a  Export of an ITAR packet asks before download"]
    S_58ea8df3["S-58ea8df3  Packet schema rejects ITAR packet carrying a non-ITAR seller quote"]
    ...
    S_9e04747d["S-9e04747d  Unknown packet still renders the shell"]
    S_e321229f["S-e321229f  Missing packet id shows a not-on-desk message"]
    ...
    S_ed931467["S-ed931467  Seller opens quote dialog on an L0 packet"]
    S_3d848957["S-3d848957  Bind quote promotes packet from L0 to L1"]
    ...
    S_39a5c4ae["S-39a5c4ae  Quote on a Draft packet is not offered"]
    ...
    S_b3a29bb1["S-b3a29bb1  Packet requires rivlet-packet/0.0.1 spec and id shape"]
    S_25ff4dda["S-25ff4dda  Packet id must match pkt_ style token"]
    ...
    S_fc3729f4["S-fc3729f4  Packet JSON larger than 512 KiB is refused"]
    S_34356641["S-34356641  Seed packets all parse and bind"]
