export const TRAVELER_SPEC = "opentraveler/0.0.1" as const;
export const TRAVELER_MEDIA = "application/vnd.opentraveler+json" as const;
...
export const MAX_TRAVELER_JSON_BYTES = 512 * 1024;
